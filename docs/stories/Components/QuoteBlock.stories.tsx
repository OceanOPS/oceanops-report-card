...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: `
Quote component with two variants: quote style (with icon) and highlight style (with border).
...
<iframe
  ...
  width="100%"
  height="450"
  src="https://www.figma.com/embed?embed_host=share&url=https://www.figma.com/design/JdNQkdV9E6lLtXAY15GM1L/Goos-Report-Card?node-id=1554-1252"
  allowfullscreen
></iframe>

**[→ Open in Figma](https://www.figma.com/design/JdNQkdV9E6lLtXAY15GM1L/Goos-Report-Card?node-id=1554-1252&t=lyDcrmhzDWxp62H7-4)**
        `,
      },
    },
  },
