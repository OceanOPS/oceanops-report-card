...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: `
Map or iframe display with optional statistics panel in a 50/50 layout.
...
<iframe
  ...
  width="100%"
  height="450"
  src="https://www.figma.com/embed?embed_host=share&url=https://www.figma.com/design/JdNQkdV9E6lLtXAY15GM1L/Goos-Report-Card?node-id=1585-2008"
  allowfullscreen
></iframe>

**[→ Open in Figma](https://www.figma.com/design/JdNQkdV9E6lLtXAY15GM1L/Goos-Report-Card?node-id=1585-2008&t=lyDcrmhzDWxp62H7-4)**
        `,
      },
    },
  },
