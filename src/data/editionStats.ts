...
export const OBSERVATIONS_PER_DAY_AVG = 106833

/** Inclusive span of the averaging period in days (derived from start/end). */
export const OBSERVATIONS_DAYS_WINDOW = 266

/** Days with at least one observation in the window. */
export const OBSERVATIONS_DAYS_WITH_DATA = 267

/** Total observations in the window. */
export const OBSERVATIONS_TOTAL = 28524288
...
export const OBSERVATIONS_PERIOD_END = '2026-09-24'
/** Same methodology, previous-year aligned window (for stat4 YoY badge). */
export const OBSERVATIONS_PER_DAY_AVG_LAST_YEAR = 125538

/** Delta vs previous year (obs/day). */
export const OBSERVATIONS_PER_DAY_DELTA_VS_LAST_YEAR = -18705
